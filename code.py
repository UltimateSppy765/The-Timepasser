            ...
            if request.json["guild_id"] == '789147777069744179' and request.json["channel_id"] == '789147777069744182':
                ...
                if cmd_name == 'simon':
                                    ...
                                    "embeds": [
                                        {
                                            ...
                                            "image": {
                                                "url": "https://cdn.discordapp.com/attachments/793873121451049080/819444809768763412/tenor_1.gif"
                                            },
                                            "footer": {
                                                "text": "Gif from Tenor",
                    ...
                    if request.json["data"]["options"][0]["name"] == "get":
                        ...
                        intup = request.json["data"]["options"][0]["options"][0]["value"]
                        inpuq = intup.lower()
